...
- CLI wrapper: use `node scripts/jsro.js <command>` or the `jsro` package bin for route, run, validate, benchmark, scorecard, marketgap, releaserisk, externalmatrix, mcpsmoke, install, and publish commands
